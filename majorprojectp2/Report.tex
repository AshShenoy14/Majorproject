...
\par
\vspace{0.15in}
\noindent The TransGraph-PPI framework achieves state-of-the-art performance with an accuracy of \textbf{98.52\%}, F1-score of \textbf{98.86\%}, and an ROC-AUC of \textbf{99.43\%}. Explainability is incorporated through SHAP analysis, allowing for the identification of conserved functional domains contributing to interactions. Furthermore, the predicted interaction network is analyzed using centrality measures to prioritize potential drug targets cross-referenced with ChEMBL.
\par
\vspace{0.15in}
...
\addplot coordinates {(Accuracy,98.52) (F1-Score,98.86) (AUROC,99.43)};
...
\bibitem{ref2}
N. Alkhateeb and M. Awad, ``Advances in Protein–Protein Interaction Prediction: A Deep Learning Perspective,'' \textit{Bioinformatics Journal Review}, 2023.

\bibitem{ref3}
W. Hu and M. Ohue, ``SpatialPPIv2: Enhancing Protein–Protein Interaction Prediction through Graph Neural Networks with Protein Language Models,'' \textit{Bioinformatics Advances}, 2024.

\bibitem{ref4}
F. Soleymani, E. Paquet, H. L. Viktor, W. Michalowski, and D. Spinello, ``ProtInteract: A Deep Learning Framework for Predicting Protein–Protein Interactions,'' \textit{Computational Biology and Medicine}, 2023.

\bibitem{ref5}
M. {\c{C}}elebi et al., ``xCAPT5: Protein–Protein Interaction Prediction Using Protein Language Model Embeddings and Deep Learning,'' \textit{Bioinformatics}, 2023.

\bibitem{ref6}
Z. Yu et al., ``Graph Neural Network Integrated with Pretrained Protein Language Model for Predicting Human–Virus PPI (DeepGNHV),'' \textit{Bioinformatics}, 2024.

\bibitem{ref7}
M. Alsamkary et al., ``Beyond Simple Concatenation: Fairly Assessing PLM Architectures for Multi-Chain PPI Prediction,'' \textit{Bioinformatics Advances}, 2025.

\bibitem{ref8}
J. Zhang et al., ``Predicting Human PPI Sites by Integrating ESM-2 Sequence Embeddings and a Gated GNN,'' \textit{Bioinformatics}, 2024.

\bibitem{ref9}
Z. Gao et al., ``PFMBench – Protein Foundation Model Benchmark,'' \textit{Nature Methods}, 2025.

\bibitem{ref10}
J. Liu and T. Zhang, ``ESM2-Driven PPI Prediction with Global-Local Graph Topology Learning (GLTPPI),'' \textit{Briefings in Bioinformatics}, 2025.
